...
{
  /*blt_int8u echo_identifier[1] = 0xFF;
  UartTransmitPacket(0xFF, 1);*/
  //blt_int8u dummy[15] = "012345678901234"/*56789012345678901234567890123456789"*/;
  //UartTransmitPacket(data, len > 10 ? 10 : len); //Echo received data back to PC for debug purposes
