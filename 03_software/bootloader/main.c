...
static void SystemClock_Config(void)
{
  ...
  /* Enable the HSE clock. */ // mod by resiz
  //LL_RCC_HSE_Enable();

  /* Wait till HSE is ready */ // mod by resiz
  /*while(LL_RCC_HSE_IsReady() != 1)
  {
    ;
  }*/

  /* Configure and enable the PLL. */ // mod by resiz
...
void HAL_MspInit(void)
{
  ...
  /* UART clock enable. */  // mod by resiz: usart2->usart3
  ...
  /* Configure GPIO pin for the LED. */ // mod by resiz
...
void HAL_MspDeInit(void)
{
  ...
  #endif
  /* UART clock disable. */ // mod by resiz: usart2->usart3
