...
void initMotorControl(void){
	...
	mot_ctrl_TimerInitStructure.TIM_Prescaler 			= 10 - 1; 				/* Clock freqeuency: 168MHz/10 = 16.8MHz */
	mot_ctrl_TimerInitStructure.TIM_Period 				= MOT_TIM_PERIOD - 1;	/* PWM frequency: 16.8MHz/1680 = 10KHz */
