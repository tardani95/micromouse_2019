 ...
 *        APB2 Prescaler                         | 2
 *-----------------------------------------------------------------------------
 *        HSI Frequency (Hz) // HSE Frequency(Hz)| 16000000 // 25000000
 *-----------------------------------------------------------------------------
 *        PLL_M                                  | 16 // 25
 *-----------------------------------------------------------------------------
 *        PLL_N                                  | 336
...
//  }
	...
	if (HSIStatus == (uint32_t) 0x01) {
		...
		/* Configure the main PLL with HSI input -- tard */
	 ...
	 configuration. User can add here some code to deal with this error  -- tard */
		/* statment only for breakpoint  -- tard */
		HSIStatus = 0x5;
	}
